                    ...
                    <li class="car-item <?php echo $statusClass; ?>">
                        ...
                        <div class="car-item-content">
                            ...
                            <div class="car-item-details">
                                ...
                                <!-- Transmission -->
                                <?php if (!empty($annonce['transmission'])): ?>
                                    <span class="card-detail">
                                        <svg width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                                            <path d="M9.11432 11.4286L4.57147 16L9.11432 20.5714" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M14.8857 11.4286L19.4286 16L14.8857 20.5714" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M12 3.42859V16.0000" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <?php echo htmlspecialchars($annonce['transmission']); ?>
                                    </span>
                                <?php endif; ?>

                                <!-- Puissance -->
                                <?php if (!empty($annonce['puissance'])): ?>
                                    <span class="card-detail">
                                        <svg width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                                            <path d="M13 4L13 11H20C20.5523 11 21 11.4477 21 12V14C21 17.3137 18.3137 20 15 20H9C5.68629 20 3 17.3137 3 14V12C3 11.4477 3.44772 11 4 11H11V4C11 3.44772 11.4477 3 12 3C12.5523 3 13 3.44772 13 4Z" stroke="currentColor" stroke-width="2"/>
                                        </svg>
                                        <?php echo htmlspecialchars($annonce['puissance']); ?> ch
                                    </span>
                                <?php endif; ?>
                            </div>
