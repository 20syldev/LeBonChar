...
<body>
    <div class="container">
        ...
        <form action="/annonce/nouveau" method="POST" class="form">
            ...
            <div class="form-group">
                <label for="image_voiture">Image de la voiture :</label>
                <input type="file" id="image_voiture" name="image_voiture" accept="image/*" required>
            </div>
