                ...
                <form action="/annonce/nouveau" method="POST" class="form" enctype="multipart/form-data">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: var(--space-md);">
                        <div class="form-group">
                            ...
                            <input type="number" id="annee" name="annee" min="1900" max="<?php echo date('Y'); ?>" placeholder="<?php echo date('Y'); ?>" required>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="car-image-upload">
                        <label class="car-image-dropzone" for="image_voiture">
