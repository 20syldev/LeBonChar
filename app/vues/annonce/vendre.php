    ...
    <div class="container">
        ...
        <div class="navigation">
            ...
            <div class="filter-group">
                <a href="/vendre?statut=actif" class="filter-btn <?php echo (!isset($_GET['statut']) || $_GET['statut'] === 'actif') ? 'active' : ''; ?>">
                    Actives
                </a>
                <a href="/vendre?statut=archive" class="filter-btn <?php echo (isset($_GET['statut']) && $_GET['statut'] === 'archive') ? 'active' : ''; ?>">
                    Archivées
                </a>
                <a href="/vendre?statut=reserve" class="filter-btn <?php echo (isset($_GET['statut']) && $_GET['statut'] === 'reserve') ? 'active' : ''; ?>">
                    Réservées
                </a>
            </div>
        </div>
                ...
                <div class="card-content text-center">
                    <div style="margin: var(--space-lg) 0;">
                        <svg width="64" height="64" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                            <path d="M8.00005 9C8.55233 9 9.00005 8.55228 9.00005 8C9.00005 7.44772 8.55233 7 8.00005 7C7.44776 7 7.00005 7.44772 7.00005 8C7.00005 8.55228 7.44776 9 8.00005 9Z" fill="var(--dark-gray)"/>
                            <path
                    ...
                    <h2 class="form-title">Vous n'avez pas encore d'annonces<?php echo isset($_GET['statut']) ? ' dans cette catégorie' : ''; ?></h2>
                            ...
                            <div class="car-item-details">
                                ...
                                <?php if ($annonce['acheteur_id'] !== null): ?>
                                    ...
                                    <span class="card-detail">
                                        ...
                                        Réservée par <?php echo htmlspecialchars($acheteurs[$annonce['acheteur_id']] ?? 'un utilisateur'); ?>
                                    </span>
                                <?php endif; ?>
                            </div>
