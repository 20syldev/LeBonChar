            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="navigation">
                        ...
                        <a href="/annonce/detail?id=<?php echo $annonce['id']; ?>" class="btn btn-secondary">Voir l'annonce</a>
                    </div>
                </div>
            </div>
        <?php else: ?>
                    ...
                    <form action="/annonce/modifier?id=<?php echo $annonce['id']; ?>" method="POST" class="form" enctype="multipart/form-data">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-lg);">
                            <div class="form-group">
                                ...
                                <input type="text" id="titre" name="titre" value="<?php echo $annonce['titre']; ?>" placeholder="Un titre attractif pour votre annonce" required>
                            </div>

                            <div class="form-group">
                                <label for="prix">Prix :</label>
                                <input type="number" id="prix" name="prix" step="0.01" value="<?php echo $voiture['prix']; ?>" placeholder="Prix en euros" required>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="marque_id" name="marque_id" onchange="nouvelleMarque()" required>
                                    ...
                                    <?php foreach ($marques as $marque): ?>
                                        <option value="<?php echo $marque['id']; ?>" <?php echo ($voiture['marque_id'] == $marque['id']) ? 'selected' : ''; ?>>
                                            <?php echo $marque['nom']; ?>
                                        </option>
                                    <?php endforeach; ?>
                                ...
                                <select id="modele_id" name="modele_id" onchange="nouveauModele()" required>
                                    ...
                                    <?php if (isset($modeles)): ?>
                                        <?php foreach ($modeles as $modele): ?>
                                            <option value="<?php echo $modele['id']; ?>" <?php echo ($voiture['modele_id'] == $modele['id']) ? 'selected' : ''; ?>>
                                                <?php echo $modele['nom']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" placeholder="Décrivez votre véhicule, son état, ses points forts..." required><?php echo $annonce['description']; ?></textarea>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: var(--space-md);">
                            <div class="form-group">
                                ...
                                <input type="number" id="annee" name="annee" value="<?php echo isset($voiture['annee']) ? date('Y', strtotime($voiture['annee'])) : ''; ?>" placeholder="<?php echo date('Y'); ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="kilometrage">Kilométrage :</label>
                                <input type="number" id="kilometrage" name="kilometrage" value="<?php echo $voiture['kilometrage']; ?>" placeholder="En kilomètres" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select id="categorie" name="categorie" required>
                                    ...
                                    <option value="Citadine" <?php echo $voiture['categorie'] === 'Citadine' ? 'selected' : ''; ?>>Citadine</option>
                                    <option value="Break" <?php echo $voiture['categorie'] === 'Break' ? 'selected' : ''; ?>>Break</option>
                                    <option value="Coupé" <?php echo $voiture['categorie'] === 'Coupé' ? 'selected' : ''; ?>>Coupé</option>
                                    <option value="Cabriolet" <?php echo $voiture['categorie'] === 'Cabriolet' ? 'selected' : ''; ?>>Cabriolet</option>
                                    <option value="Monospace" <?php echo $voiture['categorie'] === 'Monospace' ? 'selected' : ''; ?>>Monospace</option>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-md);">
                            <div class="form-group">
                                ...
                                <input type="text" id="couleur" name="couleur" value="<?php echo $voiture['couleur']; ?>" placeholder="Ex: Noir, Blanc, Rouge..." required>
                            </div>
                            <div class="form-group">
                                <label for="energie">Énergie :</label>
                                <select id="energie" name="energie" required>
                                    <option value="">Sélectionnez une énergie</option>
                                    <option value="Essence" <?php echo $voiture['energie'] === 'Essence' ? 'selected' : ''; ?>>Essence</option>
                                    <option value="Diesel" <?php echo $voiture['energie'] === 'Diesel' ? 'selected' : ''; ?>>Diesel</option>
                                    <option value="Hybride" <?php echo $voiture['energie'] === 'Hybride' ? 'selected' : ''; ?>>Hybride</option>
                                    <option value="Électrique" <?php echo $voiture['energie'] === 'Électrique' ? 'selected' : ''; ?>>Électrique</option>
                                    <option value="GPL" <?php echo $voiture['energie'] === 'GPL' ? 'selected' : ''; ?>>GPL</option>
                                    <option value="Bioéthanol" <?php echo $voiture['energie'] === 'Bioéthanol' ? 'selected' : ''; ?>>Bioéthanol</option>
                                    <option value="Autre" <?php echo $voiture['energie'] === 'Autre' ? 'selected' : ''; ?>>Autre</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: var(--space-md);">
                            ...
                            <div class="form-group">
                                ...
                                <select id="nombre_portes" name="nombre_portes" required>
                                    ...
                                    <option value="2" <?php echo $voiture['nombre_portes'] == '2' ? 'selected' : ''; ?>>2</option>
                                    <option value="3" <?php echo $voiture['nombre_portes'] == '3' ? 'selected' : ''; ?>>3</option>
                                    <option value="4" <?php echo $voiture['nombre_portes'] == '4' ? 'selected' : ''; ?>>4</option>
                                    <option value="5" <?php echo $voiture['nombre_portes'] == '5' ? 'selected' : ''; ?>>5</option>
                                    <option value="6" <?php echo $voiture['nombre_portes'] == '6' ? 'selected' : ''; ?>>6</option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select id="nombre_places" name="nombre_places" required>
                                    <option value="">Sélectionnez</option>
                                    <option value="2" <?php echo $voiture['nombre_places'] == '2' ? 'selected' : ''; ?>>2</option>
                                    <option value="3" <?php echo $voiture['nombre_places'] == '3' ? 'selected' : ''; ?>>3</option>
                                    <option value="4" <?php echo $voiture['nombre_places'] == '4' ? 'selected' : ''; ?>>4</option>
                                    <option value="5" <?php echo $voiture['nombre_places'] == '5' ? 'selected' : ''; ?>>5</option>
                                    <option value="6" <?php echo $voiture['nombre_places'] == '6' ? 'selected' : ''; ?>>6</option>
                                    <option value="7" <?php echo $voiture['nombre_places'] == '7' ? 'selected' : ''; ?>>7</option>
                                    <option value="8" <?php echo $voiture['nombre_places'] == '8' ? 'selected' : ''; ?>>8</option>
                                    <option value="9" <?php echo $voiture['nombre_places'] == '9' ? 'selected' : ''; ?>>9</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-md);">
                            <div class="form-group">
                                ...
                                <select id="sellerie" name="sellerie" required>
                                    <option value="">Sélectionnez</option>
                                    <option value="Tissu" <?php echo $voiture['sellerie'] === 'Tissu' ? 'selected' : ''; ?>>Tissu</option>
                                    <option value="Cuir" <?php echo $voiture['sellerie'] === 'Cuir' ? 'selected' : ''; ?>>Cuir</option>
                                    <option value="Alcantara" <?php echo $voiture['sellerie'] === 'Alcantara' ? 'selected' : ''; ?>>Alcantara</option>
                                    <option value="Mixte" <?php echo $voiture['sellerie'] === 'Mixte' ? 'selected' : ''; ?>>Mixte</option>
                                    <option value="Autre" <?php echo $voiture['sellerie'] === 'Autre' ? 'selected' : ''; ?>>Autre</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="consommation">Consommation (L/100km) :</label>
                                <input type="number" id="consommation" name="consommation" step="0.1" value="<?php echo $voiture['consommation']; ?>" placeholder="Ex: 5.5" required>
                            </div>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: var(--space-md);">
                            <div class="form-group">
                                ...
                                <input type="text" id="provenance" name="provenance" value="<?php echo $voiture['provenance']; ?>" placeholder="Ex: France, Allemagne..." required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="navigation mt-lg">
                            ...
                            <a href="/annonce/detail?id=<?php echo $annonce['id']; ?>" class="btn btn-home">Annuler</a>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="card-content">
                        ...
                        <div class="car-gallery">
                            <?php foreach ($images as $img): ?>
                                <div class="car-image-container">
                                    <form method="post" enctype="multipart/form-data" action="/annonce/modifier-image?id=<?php echo $img['id']; ?>&annonce_id=<?php echo $annonce['id']; ?>">
                                        <label class="car-image-edit" title="Cliquez pour modifier cette image">
                                            ...
                                            <span class="car-image-overlay">
                                                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                                                    <path d="M13.5858 3.58579C14.3668 2.80474 15.6332 2.80474 16.4142 3.58579L20.4142 7.58579C21.1953 8.36683 21.1953 9.63316 20.4142 10.4142L11.4142 19.4142C11.0391 19.7893 10.5304 20 10 20H6C4.89543 20 4 19.1046 4 18V14C4 13.4696 4.21071 12.9609 4.58579 12.5858L13.5858 3.58579Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    ...
                                    <form method="post" action="/annonce/supprimer-image?id=<?php echo $img['id']; ?>&annonce_id=<?php echo $annonce['id']; ?>">
                    ...
                    <?php if (count($images) < 3): ?>
                        <div class="car-image-upload mt-lg">
                            <form method="post" enctype="multipart/form-data" action="/annonce/ajouter-image?id=<?php echo $annonce['id']; ?>">
                                <label class="car-image-dropzone">
                                    ...
                                    <span>Ajouter des images (<?php echo 3 - count($images); ?> restantes)</span>
                                    <p>Formats acceptés : JPG, PNG, WEBP</p>
                                    <input type="file" name="images[]" accept=".jpg,.png,.webp" multiple style="display:none;" onchange="this.form.submit()" <?php echo count($images) === 0 ? 'required' : ''; ?>>
                                </label>
                            </form>
                        </div>
                    <?php endif; ?>
