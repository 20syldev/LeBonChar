                    ...
                    <div class="profile-info-card">
                        ...
                        <ul class="profile-details">
                            <li>
                                ...
                                <span class="profile-value"><?= $utilisateur['nom']; ?></span>
                            </li>
                            <li>
                                <span class="profile-label">Prénom</span>
                                <span class="profile-value"><?= $utilisateur['prenom']; ?></span>
                            </li>
                            <li>
                                <span class="profile-label">Email</span>
                                <span class="profile-value"><?= $utilisateur['email']; ?></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="profile-info-card">
                        ...
                        <ul class="profile-details">
                            <li>
                                ...
                                <span class="profile-value"><?= $utilisateur['ville']; ?></span>
                            </li>
                            <li>
                                <span class="profile-label">Code postal</span>
                                <span class="profile-value"><?= $utilisateur['code_postal']; ?></span>
                            </li>
                            <li>
                                <span class="profile-label">Adresse</span>
                                <span class="profile-value"><?= $utilisateur['adresse']; ?></span>
                            </li>
                        </ul>
                    </div>
                </div>
