        ...
        <div class="auth-box">
            ...
            <form action="/inscription" method="POST" class="auth-form">
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <button type="button" class="password-toggle" onclick="togglePassword()">
                            ...
                            <svg class="eye-slash-icon hidden" width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                                <path d="M10.7302 5.07319C11.1448 5.02485 11.5684 5 12 5C15.7574 5 18.564 7.4404 20.2326 9.43934C21.4837 10.9394 21.4837 13.0606 20.2326 14.5607C19.6081 15.3138 18.8" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <textarea
                            ...
                            rows="2"
                            data-auto-resize
                        ><?php echo isset($_POST['adresse']) ? htmlspecialchars($_POST['adresse']) : ''; ?></textarea>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary btn-block">
                    <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                        <path d="M19 21V19C19 16.7909 17.2091 15 15 15H9C6.79086 15 5 16.7909 5 19V21M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Créer mon compte
                </button>
            </form>
            ...
            <div class="auth-footer">
                ...
                <a href="/connexion" class="btn btn-secondary btn-block">
                    <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                        <path d="M11 16L15 12M15 12L11 8M15 12H3M4 8V7C4 5.89543 4.89543 5 6 5H20C21.1046 5 22 5.89543 22 7V17C22 18.1046 21.1046 19 20 19H6C4.89543 19 4 18.1046 4 17V16" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    Se connecter
                </a>
            </div>
