...
<head>
    ...
    <title>Modification du mot de passe - LeBonChar</title>
...
<body>
    <div class="container">
        ...
        <div class="nav">
            ...
            <div class="nav-right">
                <a href="/modifier" class="btn btn-home">
                    <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                        <path
        ...
        <div class="card">
            <div class="card-content">
                ...
                <p class="mb-lg">Modifiez votre mot de passe pour sécuriser votre compte. Utilisez un mot de passe fort et unique.</p>

                <form action="/mot-de-passe" method="POST" class="form">
                    <div class="form-group">
                        ...
                        <div class="password-field">
                            <input
                                ...
                                required
                            >
                            <button type="button" class="password-toggle" onclick="togglePassword('mot_de_passe_actuel')">
                                ...
                                <svg class="eye-slash-icon hidden" width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none">
                                    <path d="M10.7302 5.07319C11.1448 5.02485 11.5684 5 12 5C15.7574 5 18.564 7.4404 20.2326 9.43934C21.4837 10.9394 21.4837 13.0606 20.2326 14.5607C19.6081 15.3138 18.8 16.0211 17.8 16.6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M3.5 3L20.5 20" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M7.36209 7.55738C5.68702 8.76738 4.32481 10.5321 3.76747 11.4393C2.51645 12.9394 2.51645 15.0606 3.76747 16.5607C5.43612 18.5596 8.24271 21 12 21C13.6569 21 15.1687 20.5217 16.4966 19.8915" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M12.5 9.04148C13.7563 9.25675 14.7437 10.2441 14.959 11.5004" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-help">
                            Utilisez au moins 8 caractères avec des lettres, des chiffres et des caractères spéciaux.
                        </small>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="/compte" class="btn btn-cancel">Annuler</a>
                    </div>
                </form>

                <div class="mt-lg">
                    <h3 class="form-section-title">Conseils de sécurité</h3>
                    <ul class="tips-list">
                        <li>Ne réutilisez jamais le même mot de passe pour différents sites</li>
                        <li>Évitez d'utiliser des informations personnelles dans votre mot de passe</li>
                        <li>Changez votre mot de passe régulièrement pour plus de sécurité</li>
                    </ul>
                </div>
            </div>
        </div>
