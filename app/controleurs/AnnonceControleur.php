...
class AnnonceControleur {
    ...
    public function vendre() {
        ...
        if ($statut === 'archive') {
            $annonces = Annonce::toutesParVendeur($utilisateur_id, $statut);
            ...
            try {
                ...
                if (isset($_FILES['image_voiture']) && $_FILES['image_voiture']['error'] === UPLOAD_ERR_OK) {
                    try {
                        ...
                        $_SESSION['erreur'] = 'Erreur lors de l\'ajout de l\'image : ' . $e->getMessage();
                    }
                }
    ...
    public function ajouterAuPanier() {
        ...
        try {
            ...
            $_SESSION['message'] = 'Le véhicule a été ajouté à votre panier.';
            header('Location: ' . $redirect);
            exit;
        } catch (Exception $e) {
    ...
    public function ajouterImage() {
        ...
        $redirect = '/annonce/modifier?id=' . $annonce_id;
